...
const [currentIndex, setCurrentIndex] = useState(0);
  ...
  const specs = [
    { icon: <GiChemicalDrop />, label: "Material", value: product.material_name },
    { icon: <MdOutlineColorLens />, label: "Color", value: product.colour_name },
    ...
    { icon: <MdOutlineSecurity />, label: "UV Resistance", value: product.uv_resistance },
    { icon: <GiShield />, label: "Hydrophobic", value: product.hydrophobic },
    { icon: <GiShield />, label: "Scratch Resistant", value: product.scratch_resistant },
    { icon: <GiShield />, label: "Stain Resistant", value: product.stain_resistant },
    { icon: <GiShield />, label: "Elongation", value: product.elongation },
    { icon: <GiShield />, label: "Tear Strength", value: product.tear_strength },
    { icon: <GiShield />, label: "Temperature Resistance", value: product.tempeerature_resistance },
    { icon: <GiShield />, label: "Peel Adhesion", value: product.peel_adhesion },
    { icon: <GiShield />, label: "Anti Rockclip", value: product.anti_rockclip },
    { icon: <GiShield />, label: "Elongation TPU", value: product.elongation_rate_tpu },
    { icon: <GiShield />, label: "Elongation Hard", value: product.elongation_rate_hard },
  ];
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-8">
          ...
          {specs.map((item, i) => (
            ...
            >
              ...
              <div className="text-3xl text-gray-400" style={{color: themes.primary}}>
                {item.icon}
              </div>
